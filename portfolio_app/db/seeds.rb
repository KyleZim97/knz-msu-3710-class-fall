...
#end
#Major.create([{ name: 'Computer Science BS' }, { name: 'Data Science and Machine Learning' }, { name: 'Mechanical Engineering' }, { name: 'Business Administration' }, { name: 'Psychology' }, { name: 'Biology' }, { name: 'Mathematics' }, { name: 'Nursing' }, { name: 'English Literature' }, { name: 'Political Science' }])